...
COMMENT ON TABLE "public"."contact_submissions" IS 'Stores contact form messages from the website.';



ALTER TABLE "public"."contact_submissions" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
...
ALTER TABLE ONLY "public"."contact_submissions"
    ADD CONSTRAINT "Contact_Submissions_id_key" UNIQUE ("id");
...
CREATE POLICY "Allow public form submission" ON "public"."contact_submissions" FOR INSERT WITH CHECK (true);
