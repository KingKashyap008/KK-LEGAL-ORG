        ...
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12 mt-8">
            <button 
              ...
              className="bg-whatsapp hover:bg-green-600 text-white px-8 py-4 rounded-lg font-montserrat font-semibold text-lg transition-all duration-300 transform hover:scale-105"
            >
              WhatsApp Now
            </button>
            <button 
              onClick={scrollToContact}
              className="border-2 border-gold text-gold hover:bg-gold hover:text-black px-8 py-4 rounded-lg font-montserrat font-semibold text-lg transition-all duration-300 transform hover:scale-105"
            >
          ...
          <blockquote className="text-xl md:text-2xl text-gray-600 font-lato italic border-l-4 border-gold pl-6 max-w-3xl mx-auto">
            "Justice is not noise — it's a calm, clear voice when it matters most."
          </blockquote>
        </div>
      </div>
    </section>
